...
import netbox_scripts.scripts
from netbox_scripts import compat
from netbox_scripts.compat import compat_import, install, wrap_loader

AUTHORING_PACKAGE = 'netbox_scripts.scripts'


class CompatImportTestCase(SimpleTestCase):
    def test_a_named_legacy_import_resolves_to_the_authoring_api(self):
        # from extras.scripts import Script
        self.assertIs(compat_import('extras.scripts', fromlist=('Script',)), netbox_scripts.scripts)

    def test_a_wildcard_legacy_import_resolves_to_the_authoring_api(self):
        # from extras.scripts import *
        self.assertIs(compat_import('extras.scripts', fromlist=('*',)), netbox_scripts.scripts)

    def test_a_dotted_legacy_import_binds_the_stand_in(self):
        # import extras.scripts, and import extras.scripts as api
        self.assertIs(compat_import('extras.scripts').scripts, netbox_scripts.scripts)
    ...
    def test_importing_the_submodule_from_the_package_binds_the_stand_in(self):
        ...
        self.assertIs(compat_import('extras', fromlist=('scripts',)).scripts, netbox_scripts.scripts)

    def test_importing_the_package_alone_binds_the_stand_in(self):
        # import extras, then extras.scripts.Script
        self.assertIs(compat_import('extras').scripts, netbox_scripts.scripts)
    ...
    def test_a_star_import_of_extras_binds_the_legacy_names(self):
        ...
        self.assertIs(namespace['scripts'], netbox_scripts.scripts)
    ...
    def test_a_relative_import_of_a_real_sibling_still_resolves(self):
        ...
        self.assertIs(module, netbox_scripts.scripts.base)
...
class InstallTestCase(SimpleTestCase):
    def test_the_host_module_is_never_replaced(self):
        ...
        install()
        self.assertIsNot(sys.modules['extras.scripts'], netbox_scripts.scripts)
    ...
    def test_a_wrapped_loader_seeds_the_redirect_into_a_module(self):
        ...
        self.assertIs(module.Script, netbox_scripts.scripts.Script)
        self.assertIs(module.StringVar, netbox_scripts.scripts.StringVar)
    ...
    def test_an_unwrapped_loader_leaves_the_host_module_in_place(self):
        ...
        self.assertIsNot(module.Script, netbox_scripts.scripts.Script)

...
from netbox_scripts.storage.exceptions import ActivationError, ProjectVanishedError
from netbox_scripts.tests.storage.test_service import StorageServiceMixin, content

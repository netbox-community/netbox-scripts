...
class AppConfig(PluginConfig):
    """NetBox Scripts configuration."""

    name = 'netbox_scripts'
    label = 'netbox_scripts'
    verbose_name = 'NetBox Scripts'
    description = 'Custom Scripts for NetBox'
    version = __version__
    author = __author__
    author_email = __email__
    base_url = 'netbox-scripts'
    min_version = '4.7.0'
    max_version = '4.7.99'
...
# The authoring API (netbox_scripts.scripts) is re-exported lazily via PEP 562.

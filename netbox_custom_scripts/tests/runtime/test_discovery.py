...
from netbox_custom_scripts.tests.runtime.test_loader import OTHER_KEY, LoaderTestCase
from netbox_custom_scripts.tests.storage.test_store import STORAGE_KEY
...
class DiscoverScriptsTestCase(TestCase):
    ...
    def test_markers_land_in_the_class_dict_with_project_identity(self):
        ...
        self.assertEqual(
            ...
            f'netbox.plugins.netbox_custom_scripts.scripts.{PROJECT_KEY}.deploy.Sync',
        )
    ...
    def test_markers_carry_the_project_key_and_never_the_runtime_namespace(self):
        ...
        for marker in (found.cls.__dict__['_custom_script_module'], found.cls.__dict__['_custom_script_logger_name']):
            ...
            self.assertNotIn('_netbox_custom_scripts_runtime', marker)
...
class DiscoveryIntegrationTestCase(LoaderTestCase):
    ...
    def test_identical_names_in_two_projects_get_distinct_loggers(self):
        ...
        self.assertEqual(logger_a, 'netbox.plugins.netbox_custom_scripts.scripts.alpha.deploy.Sync')
        self.assertEqual(logger_b, 'netbox.plugins.netbox_custom_scripts.scripts.beta.deploy.Sync')

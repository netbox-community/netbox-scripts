...
│   ├── scripts/                   , Authoring API: base.py (BaseScript/Script), variables.py, forms.py (ScriptForm carries the four execution parameters, and drops the two scheduling fields when the class forbids scheduling), logging.py, exceptions.py.

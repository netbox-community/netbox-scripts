...
from netbox_scripts.api.serializers import CustomScriptProjectRevisionSerializer
...
class CustomScriptProjectRevisionAPIViewTestCase(PluginAPIViewTestCase, APITestCase):
    ...
    def _list_url(self):
        return reverse('plugins-api:netbox_scripts-api:customscriptprojectrevision-list')

    def _detail_url(self):
        return reverse('plugins-api:netbox_scripts-api:customscriptprojectrevision-detail', args=[self.revision.pk])

    def test_the_list_route_returns_revisions(self):
        self.add_permissions('netbox_scripts.view_customscriptprojectrevision')
    ...
    def test_post_is_refused(self):
        self.add_permissions('netbox_scripts.add_customscriptprojectrevision')
    ...
    def test_put_is_refused(self):
        self.add_permissions('netbox_scripts.change_customscriptprojectrevision')
    ...
    def test_delete_is_refused(self):
        self.add_permissions('netbox_scripts.delete_customscriptprojectrevision')

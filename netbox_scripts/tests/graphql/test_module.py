...
from netbox_scripts.choices import ModuleDiscoveryStatusChoices
from netbox_scripts.graphql.enums import ModuleDiscoveryStatusEnum
from netbox_scripts.graphql.types import CustomScriptModuleType

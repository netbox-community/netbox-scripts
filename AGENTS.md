...
│   ├── tables/
│   │   ├── __init__.py            , Re-exports ScriptFileTable, ScriptProjectFileTable, ScriptProjectRevisionEntrypointTable, ScriptProjectRevisionTable, ScriptProjectTable, NetBoxScriptTable.

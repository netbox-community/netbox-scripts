...
from netbox_scripts.graphql.enums import ActivationPolicyEnum, ProjectSourceTypeEnum
from netbox_scripts.graphql.types import ScriptProjectType


class ScriptProjectGraphQLTestCase(SimpleTestCase):
    ...
    def test_active_revision_not_exposed_on_object_type(self):
        field_names = {field.name for field in ScriptProjectType.__strawberry_definition__.fields}
